namespace mkpsf2fe
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tbOutput.Text = "源目录:BD/HD/SQ 文件路径.\r\n模块目录:IRX文件的路径.\r" +
                "\n\r\n注意:确保匹配的BD/HD/SQ文件具有相同的文件名.";
            // 
            // label2
            // 
