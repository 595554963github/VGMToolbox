...
namespace VGMToolbox.plugin
{
    ...
    //public partial class AVgmtForm : Form
    {
        ...
        protected virtual void backgroundWorker_ReportProgress(object sender, ProgressChangedEventArgs e)
        {
            ...
            bool hasValidProgressStruct = false;
            VGMToolbox.util.ProgressStruct vProgressStruct = new VGMToolbox.util.ProgressStruct();

            if (e.UserState != null && e.UserState is VGMToolbox.util.ProgressStruct)
            {
                vProgressStruct = (VGMToolbox.util.ProgressStruct)e.UserState;
                hasValidProgressStruct = true;
            }
                ...
                e.ProgressPercentage != Constants.ProgressMessageOnly)
            {
                ...
                if (hasValidProgressStruct && !String.IsNullOrEmpty(vProgressStruct.GenericMessage))
                {
                    this.tbOutput.Text += vProgressStruct.GenericMessage;
                }
            }

            if (e.ProgressPercentage == Constants.ProgressMessageOnly && hasValidProgressStruct)
            {
            ...
            else if (hasValidProgressStruct)
            {
