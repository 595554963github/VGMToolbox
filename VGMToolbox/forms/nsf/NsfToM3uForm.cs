...
namespace VGMToolbox.forms.nsf
{
    public partial class NsfToM3uForm : AVgmtForm
    {
        ...
        {
            // set title
            this.lblTitle.Text = ConfigurationManager.AppSettings["Form_NsfM3u_Title"];
            ...
            this.grpOptions.Text =
                ConfigurationManager.AppSettings["Form_NsfM3u_GroupOptions"];
            this.cbOneM3uPerTrack.Text =
                ConfigurationManager.AppSettings["Form_NsfM3u_CheckBoxOneM3uPerTrack"];
            this.cbUseKnurekFormat.Text =
                ConfigurationManager.AppSettings["Form_NsfM3u_CheckBoxUseKnurekFormat"];
        }
        ...
        {
            return ConfigurationManager.AppSettings["Form_NsfM3u_MessageCancel"];
        }
        protected override string getCompleteMessage()
        {
            return ConfigurationManager.AppSettings["Form_NsfM3u_MessageComplete"];
        }
        protected override string getBeginMessage()
        {
            return ConfigurationManager.AppSettings["Form_NsfM3u_MessageBegin"];
        }
