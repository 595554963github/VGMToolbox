...
namespace VGMToolbox.forms.xsf
{
    public partial class Mkpsf2FrontEndForm : AVgmtForm
    {
            ...
            : base(pTreeNode)
        {
            ...
            this.lblPsf2LibName.Text = ConfigurationManager.AppSettings["Form_MkPsf2FE_LblPsf2LibName"];
            this.cbMakePsf2Lib.Text = ConfigurationManager.AppSettings["Form_MkPsf2FE_CheckBoxMakePsf2Lib"];

            this.cbTryCombinations.Text = ConfigurationManager.AppSettings["Form_MkPsf2FE_CheckBoxTryCombinations"];
