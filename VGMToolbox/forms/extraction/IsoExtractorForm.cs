...
namespace VGMToolbox.forms.extraction
{
    public partial class IsoExtractorForm : AVgmtForm
    {
            ...
            : base(pTreeNode)
        {
            ...
            //this.tbOutput.Text += "- 当前支持的档案类型: CRI CPK, Microsoft STFS (XBLA),任天堂U8档案(Wii)" + Environment.NewLine;
            this.tbOutput.Text += "- 当前支持的档案类型:CRI CPK,任天堂U8档案(Wii)" + Environment.NewLine;
