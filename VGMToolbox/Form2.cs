...
namespace VGMToolbox
{
    public partial class Form2 : Form
    {
        ...
        private TreeNode buildNsfTreeNode()
        {
            ...
            // NSF to M3U
            TreeNode nsfM3uNode = new TreeNode("NSF M3U创建器");
        ...
        private TreeNode buildXsfTreeNode()
        {
            ...
            //////////////////////
            TreeNode psxSepSeqExtractorNode = new TreeNode(ConfigurationManager.AppSettings["MenuTree_SepToSeqExtractorNode"]);
